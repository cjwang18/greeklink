...
/**
 * This is the model class for table "profiles_committeeInvolvement".
 *
 * The followings are the available columns in table 'profiles_committeeInvolvement':
 * @property string $id
 ...
 */
class CommitteeInvolvement extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CommitteeInvolvement the static model class
	 */
	...
	{
		return 'profiles_committeeInvolvement';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, profileID, name, beginSemester, beginYear, endSemester, endYear, present', 'safe', 'on'=>'search'),
		);
	}
