...
/**
 * This is the model class for table "profiles_workExperience".
 *
 * The followings are the available columns in table 'profiles_workExperience':
 * @property string $id
...
class WorkExperience extends CActiveRecord
{
	...
	{
		return 'profiles_workExperience';
	}
